...
namespace GRB
{
	...
	Greibach greibach(NS('S'), TS('$'), 8,
		...
		Rule(NS('N'), GRB_ERROR_SERIES + 1, 20,   //возможные конструкци  в €зыке
		...
		Rule(NS('E'), GRB_ERROR_SERIES + 2, 6, // ошибка в инициализации
			Rule::Chain(1, TS('i')),
			Rule::Chain(1, TS('l')),
		...
		Rule(NS('K'), GRB_ERROR_SERIES + 6, 6, //условие
			Rule::Chain(1, TS('l')),
			Rule::Chain(1, TS('i')),
