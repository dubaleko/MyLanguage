...
namespace Error
{
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(702,"Тип данных справа  в выражении должен  совпадать с типом слева"), ERROR_ENTRY(703, "Для сравнения в блоке if могут использоваться только литералы или идентификаторы типа bool"), 
		ERROR_ENTRY(704, "Деление в выражении на ноль."),ERROR_ENTRY(705, "В программе может быть только одна тока входа")
	};
