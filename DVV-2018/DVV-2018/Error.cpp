...
namespace Error
{
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(702,"Тип данных идентификатора и литерала при инициализации должны совпадать"), ERROR_ENTRY(703, "В арифметических выражениях операнды должны иметь  тип данных integer"), 
		ERROR_ENTRY(704, "Для сравнения в блоке if может использоваться только литерал типа bool"), ERROR_ENTRY(705, "Деление в выражении на ноль."),ERROR_ENTRY(706, "В программе может быть только одна тока входа")
	};
